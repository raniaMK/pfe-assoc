                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nom_marchand" value="{{$marchand->nom_marchand}}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="prenom_marchand" value="{{$marchand->prenom_marchand}}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="CIN" value="{{$marchand->CIN}}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="tel" value="{{$marchand->tel}}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="login" value="{{$marchand->login}}"
                                                           class="form-control" placeholder="Prenom" disabled>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="adresse_marchand" value="{{$marchand->adresse_marchand}}"
